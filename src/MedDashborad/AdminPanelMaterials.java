...
public class AdminPanelMaterials extends TestBase{
	...
	public void SearchTextBox()
	{
		...
		search.sendKeys("6");
		boolean Actual = driver.findElement(By.xpath("//td[text()=' stealx ']")).isDisplayed();
	...
	public void EditButton()
	{
		...
		driver.findElement(By.id("title_en")).sendKeys("Material#1");
	...
	public void AddBrand()
	{
		...
		driver.findElement(By.id("title_en")).sendKeys("Material#1");
		driver.findElement(By.id("title_ar")).sendKeys("Material#1");
		driver.findElement(By.xpath("//button[text()='Save']")).click();
	}
