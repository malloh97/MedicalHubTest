...
public class AdminPanelTourisum extends TestBase {
	...
	public void ShowEntiersTourisum()
	{
		driver.findElement(By.xpath("//span[text()='News & Blogs']")).click();
		driver.findElement(By.xpath("//span[text()='Tourisum']")).click();
	...
	public void SearchTextBoxTourisum()
	{
		driver.findElement(By.xpath("//span[text()='News & Blogs']")).click();
		driver.findElement(By.xpath("//span[text()='Tourisum']")).click();
		WebElement search = driver.findElement(By.xpath("//input[@type='search']"));
		search.sendKeys("4");
		boolean Actual = driver.findElement(By.xpath("//td[text()=' sadfasdf ']")).isDisplayed();
		Assert.assertTrue(Actual);
	}
	
	@Test(priority=3, enabled=false) 
	public void ShowButtonTourisum()
	{
		driver.findElement(By.xpath("//span[text()='News & Blogs']")).click();
		driver.findElement(By.xpath("//span[text()='Tourisum']")).click();
		driver.findElement(By.xpath("//a[@title='View']")).click();
		boolean Actual = driver.findElement(By.xpath("//input[@value='sadfasdf']")).isDisplayed();
		Assert.assertTrue(Actual);
	}
	
	@Test(priority=4)
	public void EditButtonTourisum()
	{
		driver.findElement(By.xpath("//span[text()='News & Blogs']")).click();
		driver.findElement(By.xpath("//span[text()='Tourisum']")).click();
		driver.findElement(By.xpath("//a[@title='Edit']")).click();
        driver.findElement(By.id("title_en")).clear();
		driver.findElement(By.id("title_en")).sendKeys("Tourisum#1");
	...
	public void DownloadPDFTourisum()
	{
		driver.findElement(By.xpath("//span[text()='News & Blogs']")).click();
		driver.findElement(By.xpath("//span[text()='Tourisum']")).click();
	...
	public void DownloadCSVTourisum()
	{
		driver.findElement(By.xpath("//span[text()='News & Blogs']")).click();
		driver.findElement(By.xpath("//span[text()='Tourisum']")).click();
	...
	public void DownloadExcelTourisum()
	{
		driver.findElement(By.xpath("//span[text()='News & Blogs']")).click();
		driver.findElement(By.xpath("//span[text()='Tourisum']")).click();
		driver.findElement(By.xpath("//span[text()='Excel']")).click();
	...
	public void AddTourisum()
	{
	    ...
	    driver.findElement(By.id("title_en")).sendKeys("Tourisum#1");
		driver.findElement(By.id("title_ar")).sendKeys("Tourisum#1");
		...
		driver.findElement(By.id("file")).sendKeys("C:\\Users\\ahmad\\Downloads\\Translated 07.jpeg");
		driver.findElement(By.xpath("//button[text()='Save']")).click();
	}


	@Test(priority=9, enabled=false) 
	public void DeleteButtonTourisum()
	{
		driver.findElement(By.xpath("//span[text()='News & Blogs']")).click();
		driver.findElement(By.xpath("//span[text()='Tourisum']")).click();
		driver.findElement(By.xpath("(//a[@title='Delete'])[3]")).click();
